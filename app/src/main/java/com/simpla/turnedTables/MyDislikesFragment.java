...
public class MyDislikesFragment extends Fragment {
    ...
    private void findIds(View v){
        ...
        //change Title,
        title.setText(getResources().getString(R.string.myDislikes));
        setAds();
        setListeners();
        setupRw();
    }
    ...
    private void setListeners(){
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction().remove(MyDislikesFragment.this).commit();
    ...
    private void loadRatings(){
        mRef.child("users").child(myUid).child("myDislikes").orderByValue().limitToLast(numOfItems)
    ...
    private void loadMore(){
        ...
        mRef.child("users").child(myUid).child("myDislikes").orderByValue().endAt(startKey)
